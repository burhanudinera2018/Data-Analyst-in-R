...
![data.table](images/Screen Shot 2024-08-29 at 06.59.21.png)
...
```{r 77 control store}
#### Select control stores based on the highest matching store (closest to 1 but not the store itself, i.e. the second #### ranked highest store) Over to you! Select the most appropriate control store for trial store 77 by finding the store #### with the highest final score.
...
<code style="background:yellow;color:black">+ Let's see if the difference is significant!</code>
...
<code style="background:pink;color:black">+ Let's again see if the difference is significant visually! </code>
